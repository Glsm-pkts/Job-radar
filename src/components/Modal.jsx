        ...
        <span></span>
              ...
              {d.aircraft.images ? (
                <img src= { d.aircraft.images?.large
                    ...
                    : d.aircraft.images.thumbnails[0].src}alt="" />
...
<p>
    <span>Kalkış: </span>
    <a href={d.airport?.origin?.website}target='blank'>
...
<p>
    <span>İniş: </span>
    <a href={d.airport?.destination?.website}target='blank'>
...
<p>
    ...
    <span>{d.time?.scheduled?.departure > 0 ? formatDate(d.time?.scheduled?.arrival)
    : "Bilinmiyor"}</span>
</p>
